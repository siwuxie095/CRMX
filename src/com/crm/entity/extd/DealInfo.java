...
public class DealInfo extends AbstractCrmName {
	...
	public String toString() {
		return "DealInfo [dealId=" + dealId + ", dealThm=" + dealThm + ", custName=" + custName + ", ctcName=" + ctcName
				+ ", oppId=" + oppId + ", ofrId=" + ofrId + ", dealStatus=" + dealStatus + ", dealDate=" + dealDate
				+ ", overDate=" + overDate + ", saleSum=" + saleSum + ", prodSort=" + prodSort + ", crmName=" + crmName
				+ "]";
	}
