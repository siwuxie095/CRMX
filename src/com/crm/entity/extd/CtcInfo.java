...
public class CtcInfo extends AbstractCrmId {
	...
	public String toString() {
		return "CtcInfo [ctcId=" + ctcId + ", ctcName=" + ctcName + ", custName=" + custName + ", ctcTitle=" + ctcTitle
				+ ", ctcCel=" + ctcCel + ", ctcTel=" + ctcTel + ", ctcFax=" + ctcFax + ", ctcMail=" + ctcMail
