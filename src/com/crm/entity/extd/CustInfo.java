...
public class CustInfo extends AbstractCrmId {
	...
	public String toString() {
		return "CustInfo [custId=" + custId + ", custName=" + custName + ", custStatus=" + custStatus + ", custType="
				+ custType + ", custLvl=" + custLvl + ", custInd=" + custInd + ", custProv=" + custProv + ", custCity="
				+ custCity + ", custAddr=" + custAddr + ", custRmk=" + custRmk + ", crmId=" + crmId + "]";
	}
