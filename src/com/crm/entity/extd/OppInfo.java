...
public class OppInfo extends AbstractCrmName {
	...
	public String toString() {
		return "OppInfo [oppId=" + oppId + ", oppName=" + oppName + ", custName=" + custName + ", ctcName=" + ctcName
				+ ", prodSort=" + prodSort + ", preDealDate=" + preDealDate + ", preSaleSum=" + preSaleSum + ", oppSrc="
				+ oppSrc + ", saleStg=" + saleStg + ", succPer=" + succPer + ", oppRmk=" + oppRmk + ", crmName="
				+ crmName + "]";
	}
