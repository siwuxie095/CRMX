...
<%@ include file="/xcrm/bootstrap/nav.jsp" %>
	...
	<%
		...
		int num=custInfoDao.getNum();
		
		List<Object> list=custInfoDao.getAllId();
...
<div class="container-fluid">
	<div class="row-fluid">
		...
		<form class="form-horizontal"
			action="<%=request.getContextPath()%>/cust_info_add.action" method="post" name="iForm">
