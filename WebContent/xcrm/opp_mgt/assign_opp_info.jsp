...
<%
	...
	List<Object> list=crmInfoDao.getAllName();
	...
	<div class="row-fluid">
		...
		<br/><br/>
		 <form class="form-horizontal"
			action="<%=request.getContextPath()%>/opp_info_modify.action" method="post" name="iForm">
			<table class="table table-bordered">
					...
					<tr class="success">
						...
						<td>
							<div class="input-append">
								...
								<option value="<%= str[i]%>"><%out.print(str[i]); %></option> 
								<% } %>
								</select>
							</div>
						</td>
				...
				<tbody>
				 ...
				 <div class="control-group">
						<div class="controls">
							 <button class="btn" type="submit">保存</button> &nbsp;&nbsp; <a href="<%= request.getContextPath() %>/xcrm/opp_mgt/qry_all_opp_info.jsp"><button class="btn" type="button">取消</button></a>
						</div>
					</div>
			</form>
			</div>
