		...
		<div class="span12">
			<div class="navbar navbar-inverse">
				<div class="navbar-inner">
					<div class="container-fluid">
						 <a data-target=".navbar-responsive-collapse" data-toggle="collapse" class="btn btn-navbar"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></a> <a href="#" class="brand">Alpha CRM Plus</a>
						<div class="nav-collapse collapse navbar-responsive-collapse">
							<ul class="nav">
								...
								%>
								 <li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li>
											<a href="<%= request.getContextPath() %>/crm_info_queryAll.action">权限管理</a>
										</li>
										<li>
											<a href="<%= request.getContextPath() %>/crm_pwdx_queryAll.action">密码管理</a>
										</li>
									</ul>
								</li>
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
									    <li>
											<a href="<%= request.getContextPath() %>/cust_info_queryAll.action">全部客户</a>
										</li>
										...
										<a tabindex="-1" href="#">客户状态</a>
											...
											<li>
											<a href="<%= request.getContextPath() %>/cust_info_queryByStatus.action?custStatus=潜在客户">潜在客户</a>
											</li>
											<li>
											<a href="<%= request.getContextPath() %>/cust_info_queryByStatus.action?custStatus=意向客户">意向客户</a>
											</li>
											<li>
											<a href="<%= request.getContextPath() %>/cust_info_queryByStatus.action?custStatus=成交客户">成交客户</a>
											</li>
											<li>
											<a href="<%= request.getContextPath() %>/cust_info_queryByStatus.action?custStatus=流失客户">流失客户</a>
											</li>
										</ul>
										...
										<a tabindex="-1" href="#">客户类型</a>
											...
											<li>
											<a href="<%= request.getContextPath() %>/cust_info_queryByType.action?custType=小型客户">小型客户</a>
											</li>
											<li>
											<a href="<%= request.getContextPath() %>/cust_info_queryByType.action?custType=中型客户">中型客户</a>
											</li>
											<li>
											<a href="<%= request.getContextPath() %>/cust_info_queryByType.action?custType=大型客户">大型客户</a>
											</li>
										</ul>
									</li>
									...
									<li class="dropdown-submenu">
										<a tabindex="-1" href="#">客户级别</a>
											...
											<li>
											<a href="<%= request.getContextPath() %>/cust_info_queryByLvl.action?custLvl=S 级客户">S 级客户</a>
											</li>
											<li>
											<a href="<%= request.getContextPath() %>/cust_info_queryByLvl.action?custLvl=A 级客户">A 级客户</a>
											</li>
											<li>
											<a href="<%= request.getContextPath() %>/cust_info_queryByLvl.action?custLvl=B 级客户">B 级客户</a>
											</li>
											<li>
											<a href="<%= request.getContextPath() %>/cust_info_queryByLvl.action?custLvl=C 级客户">C 级客户</a>
											</li>
											<li>
											<a href="<%= request.getContextPath() %>/cust_info_queryByLvl.action?custLvl=D 级客户">D 级客户</a>
											</li>
										</ul>
									</li>
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li>
											<a href="<%= request.getContextPath() %>/ctc_info_queryAll.action">联系人</a>
										</li>
									</ul>
								</li>
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li>
											<a href="<%= request.getContextPath() %>/opp_info_queryAll.action">销售机会</a>
										</li>
										<li>
											<a href="<%= request.getContextPath() %>/ofr_info_queryAll.action">报价单</a>
										</li>
										<li>
											<a href="<%= request.getContextPath() %>/deal_info_queryAll.action">合同订单</a>
										</li>
									</ul>
								</li>
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li>
											<a href="<%= request.getContextPath() %>/log_info_queryAll.action">跟踪记录</a>
										</li>
									</ul>
								</li>
							...
							<ul class="nav pull-right">
    							  ...
    							  //从session从获取用户的登录状态
									...
									<% if(objX==null){ %>
										...
										<li>
										<a href="<%= request.getContextPath() %>/crm_pwdx_logout.action">退出</a>
										</li>
