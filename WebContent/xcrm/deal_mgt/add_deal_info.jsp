...
<%
	...
	List<Object> list=dealInfoDao.getAllId();
	...
	List<Object> listw=ofrInfoDao.getAllId();
	Object[] objArrw=listw.toArray();
	String[] strw=new String[listw.size()];
	
	for(int i=0;i<listw.size();i++){
		strw[i]=objArrw[i].toString();
	}
	...
	<div class="row-fluid">
		...
		<br/><br/>
		  <form class="form-horizontal"
			action="<%=request.getContextPath()%>/deal_info_add.action"
					...
					<tr class="warning">
						...
						<td>
							<div class="input-append">
								...
								<option value="<%= strw[i]%>"><%out.print("["+numberd+"] "+strw[i]); %></option> 
								<% numberd++; } %>
								</select>
							</div>			
						</td>
