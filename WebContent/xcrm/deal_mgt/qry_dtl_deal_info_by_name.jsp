...
<div class="container-fluid">
	<div class="row-fluid">
		...
		<div class="btn-group table-bordered">
			...
			<a  href="<%= request.getContextPath() %>/xcrm/deal_mgt/mod_deal_info.jsp?dealId=<s:property value="dealInfo.dealId"></s:property>" class="btn"> <span class="add-on"><i class="icon-edit"></i></span>&nbsp;编辑</a>
		</div>
		<br/><br/>
