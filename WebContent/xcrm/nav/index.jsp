	...
	<div class="row-fluid">
		<div class="span12">
			<div class="hero-unit" id="box">
				...
				<br/>
				<p>
					Alpha CRM Plus 系统作为最懂业务的销售管理平台，为企业用户提供最先进、最全面的销售管理解决方案。互联网与移动互联网平台的多网络模式服务，针对企业业务的特点，在售前、售中、售后三个阶段提供国内最优质的在线客户管理系统服务...
				</p>
				<p>
					<a class="btn btn-inverse btn-large" href="<%= request.getContextPath() %>/xcrm/nav/look_more.jsp">查看更多 »</a>
				</p>
			</div>
